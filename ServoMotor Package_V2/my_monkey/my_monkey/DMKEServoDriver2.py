  ...
  ################################################################################################3
    ...
    def start_trigger_relative(self):
        try:
            ...
            print("Failed to start trigger for absolute position")
    ...
    def read_actual_pos(self):
        try:
            ...
            print("Failed to read current position of motor")
    ...
    def read_actual_speed(self):
        try:
            ...
            speed = actual_speed.raw  # Get the raw bytes
    ...
    def read_actual_current(self):
        try:
            ...
            current = actual_current.raw  # Get the raw bytes
