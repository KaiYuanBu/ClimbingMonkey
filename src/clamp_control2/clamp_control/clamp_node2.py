...
class MotorControlNode(Node):
    def __init__(self):
        ...
        self.srv = self.create_service(GetPosition, 'get_motor_position', self.get_motor_position)
    ...
    def get_motor_position(self, instance, response):
        # This method will be called when a service request is received
        # You can add the logic to read the motor position here
        # For now, we'll just return a dummy value
        response.position = instance.read_actual_pos()  # Dummy position value
        return response
