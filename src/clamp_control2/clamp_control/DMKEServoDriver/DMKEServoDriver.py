...
# /home/bky/my_monkey/src/clamp_control/clamp_control/DMKEServoDriver/DCHCAN.eds

# # Get the directory of the current script
# current_dir = os.path.dirname(os.path.abspath(__file__))

# # Assuming 'DCHCAN.eds' is in a 'files' subdirectory
# eds_file = os.path.join(current_dir, 'files', 'DCHCAN.eds')
...
class DMKEServoDriver2_V1:
    ...
    def __init__(self, network:canopen.Network, node_id) -> None:
        ...
        self.node = network.add_node(node_id, '/home/bky/my_monkey/src/clamp_control2/clamp_control/DMKEServoDriver/DCHCAN.eds')
